...
stepsFixed = [
  { label: 'Confirmado', dbStatus: 'Pendiente' },   // Índice 0
  { label: 'Preparando', dbStatus: 'Procesando' },  // Índice 1
  { label: 'Enviado',    dbStatus: 'Enviado' },     // Índice 2
  { label: 'Entregado',  dbStatus: 'Completado' }   // Índice 3 (FINAL)
];
...
isStepCompleted(index: number): boolean {
  ...
  statusIcons(label: string): string {
    switch (label) {
      case 'Confirmado': return 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z';
      case 'Preparando': return 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4';
